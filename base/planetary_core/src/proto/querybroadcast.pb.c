 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(QueryBroadcast, parentId) < 256 && pb_membersize(QueryBroadcast, query) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_QueryBroadcast)
#endif
