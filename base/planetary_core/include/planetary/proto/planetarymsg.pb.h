...
extern const pb_field_t PlanetaryMessage_fields[5];

/* Maximum encoded size of messages (where known) */
#define PlanetaryMessage_size                    (5 + sizeof(union{char f1[QueryBroadcast_size]; char f2[QueryParentSel_size]; char f3[Resultset_size]; char f4[CancelQueryMessage_size];}))
